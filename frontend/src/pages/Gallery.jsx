            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {galleryPhotos.map((photo, i) => (
                    <SectionReveal key={i} delay={i * 0.1}>
                        <div className="relative group overflow-hidden rounded-3xl border border-dustyRose/30 h-80 shadow-wineShadow">
                            <img
                                src={photo.url}
                                alt={photo.title}
                            ...
                            <div className="absolute bottom-5 left-5">
                                <span className="text-[11px] uppercase text-dustyRose font-bold tracking-widest">Live Stage</span>
