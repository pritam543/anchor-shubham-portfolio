...
export default function Contact() {
    ...
    return (
        <div className="py-20 bg-burgundy text-cream">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    <SectionReveal delay={0.1} className="space-y-6">
                        <div className="bg-deepWine border border-roseGold/30 p-6 rounded-3xl shadow-roseGlow">
                    ...
                    <SectionReveal delay={0.2} className="md:col-span-2">
                        <form onSubmit={handleSubmit} className="bg-deepWine border border-roseGold/30 p-8 rounded-3xl space-y-6 shadow-roseGlow">
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-burgundy/60 border border-nudeBeige/30 rounded-xl px-4 py-3.5 text-cream placeholder-nudeBeige/40 focus:border-roseGold outline-none"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-burgundy/60 border border-nudeBeige/30 rounded-xl px-4 py-3.5 text-cream focus:border-roseGold outline-none"
                                    >
                            ...
                            <button
                                type="submit"
                                className="w-full bg-roseGold text-deepWine hover:bg-cream hover:text-burgundy font-extrabold py-4 rounded-xl shadow-roseGlow transition-all duration-300 flex items-center justify-center gap-2 text-xs uppercase tracking-widest"
                            >
